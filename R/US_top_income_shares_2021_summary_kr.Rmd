---
title: "US Top Income Share 1913 ~ 2021 (도표)"
author: "coop711"
date: "`r Sys.Date()`"
...
준비한 자료는  [E. Saez 교수의 홈페이지](http://elsa.berkeley.edu/~saez/)에 있는 [`TabFig2021.xlsx`](http://eml.berkeley.edu//~saez/TabFig2021.xlsx) 를 손봐서 불러들인 것이다. 
...
<!--작업을 마친 자료파일은 `US_top_income_shares_21`이며, 이 자료의 구조와 앞의 몇 열의 값은 다음과 같다.-->
...
kable(US_top_income_shares_21)
# kable(US_top_income_shares_21[c(11:20, 41:51, 92:106), ])
```
...
# png(file = "../pics/US_top_income_share_10_2021_72dpi_kr.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_10_2021_300dpi_kr.png", width = 1280, height = 720)
par(family = "KoPubWorldDotum Medium")
x_lab <- "연도"
y_lab <- "소득 점유(%)"
plot(P90_100 ~ Year, 
     data = US_top_income_shares_21, 
     xlab = x_lab, 
     ylab = y_lab, 
     xlim = c(1910, 2020), 
     ylim = c(30, 60), 
...
# lines(P95_99 ~ Year, data = US_top_income_shares_21, type = "b", pch = 17, col = "red")
# lines(P90_95 ~ Year, data = US_top_income_shares_21, type = "b", pch = 17, col = "blue")
abline(h = seq(30, 60, by = 5), 
       lty = 3)
abline(v = seq(1910, 2020, by = 10), 
       lty = 3)
# legend.text <- "Top 10% (incomes above $121,360 in 2021)")
# legend(x = 1940, y = 25, legend = legend.text, pch = 17, col = "black")
main_title <- "미국 상위 10% 소득 점유(1917 ~ 2021)"
...
text(x = c(1935, 1965, 2015), 
     ...
     col = "red")
dev.copy(png, 
         file = "../pics/US_top_income_share_10_2021_kr.png", 
         width = 960, 
         height = 540)
dev.off()
```
...
# png(file = "../pics/US_top_income_share_1-4-5_2021_72dpi_kr.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_1-4-5_2021_300dpi_kr.png", width = 1280, height = 720)
par(family = "KoPubWorldDotum Medium")
plot(P99_100 ~ Year, 
     data = US_top_income_shares_21, 
     xlab = x_lab, 
...
abline(v = seq(1910, 2020, by = 10), 
       lty = 3)
legend_text_1 <- c("99-100%:$627,010 이상(2021년 기준)", 
...
main_title_1 <- "미국 상위 10% 소득 점유 분할 (1913 ~ 2021)"
...
#     labels = times_label, 
     ...
     col = "red")
dev.copy(png, 
#         file = "../pics/US_top_income_share_1-4-5_2021_kr.png", 
         file = "../pics/US_top_income_share_1-4-5_2021_kr_Q.png", 
         width = 960, 
         height = 540)
dev.off()
```
...
# png(file = "../pics/US_top_income_share_0.1-0.4-0.5_2021_72dpi_kr.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_0.1-0.4-0.5_2021_300dpi_kr.png", width = 1280, height = 720)
par(family = "KoPubWorldDotum Medium")
plot(P99.9_100 ~ Year, 
     data = US_top_income_shares_21, 
     xlab = x_lab, 
...
abline(v = seq(1910, 2020, by = 10), 
       lty = 3)
legend_text_2 <- c("99.9-100%:$3,365,700 이상(2021년 기준)", 
...
legend(x = 1946, 
       ...
       pch = 17, 
       col = c("black", "red", "blue"))
main_title_2 <- "미국 상위 1% 소득 점유 분할 (1913 ~ 2021)"
...
text(x = c(1935, 1965, 2015), 
     ...
     col = "red")
dev.copy(png, 
         file = "../pics/US_top_income_share_0.1-0.4-0.5_2021_kr.png", 
         width = 960, 
         height = 540)
dev.off()
```
...
# png(file = "../pics/US_top_income_share_0.01-0.09_2021_72dpi_kr.png", width = 864, height = 486)
# png(file = "../pics/US_top_income_share_0.01-0.09_2021_300dpi_kr.png", width = 1280, height = 720)
par(family = "KoPubWorldDotum Medium")
...
abline(v = seq(1910, 2020, by = 10), 
       lty = 3)
legend_text_3 <- c("99.99-100%:$19,086,000 이상(2021년 기준)", 
...
legend(x = 1945, 
       ...
       pch = 17, 
       col = c("black", "blue"))
main_title_3 <- "미국 상위 0.1% 소득 점유 분할 (1913 ~ 2021)"
...
text(x = c(1935, 1965, 2015), 
     ...
     col = "red")
dev.copy(png, 
         file = "../pics/US_top_income_share_0.01-0.09_2021_kr.png", 
         width = 960, 
         height = 540)
dev.off()
```
...
library(tidyverse)
data_10_df <- 
  US_top_income_shares_21[c("Year", "P90_100")]
data_10 <- 
  US_top_income_shares_21[c("Year", "P99_100", "P95_99", "P90_95")]
data_10_tbl <- 
  data_10 %>%
  as_tibble %>%
...
data_1 <- 
  US_top_income_shares_21[c("Year", "P99.9_100", "P99.5_99.9", "P99_99.5")]
data_1_tbl <- 
  data_1 %>%
  as_tibble %>%
  gather(key = "Percentiles", value = "Share", -Year) %>%
...
data_01 <- 
  US_top_income_shares_21[c("Year", "P99.99_100", "P99.9_99.99")]
data_01_tbl <- 
  data_01 %>%
  as_tibble %>%
  gather(key = "Percentiles", value = "Share", -Year) %>%
...
ggsave("../pics/US_top_income_share_10_2021_ggplot_kr.png", 
       width = 12, 
       height = 6.75)
```
...
ggsave("../pics/US_top_income_share_1-4-5_2021_ggplot_kr.png", 
       width = 12, 
       height = 6.75)
```
...
ggsave("../pics/US_top_income_share_0.1-0.4-0.5_2021_ggplot_kr.png", 
       width = 12, 
       height = 6.75)
```
...
ggsave("../pics/US_top_income_share_0.01-0.09_2021_ggplot_kr.png", 
       width = 12, 
       height = 6.75)
```
...
```{r, save.image}
# save.image(file = "US_top_income_shares_2021_add.rda")
```
-->
