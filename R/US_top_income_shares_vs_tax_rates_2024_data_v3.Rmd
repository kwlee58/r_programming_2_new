---
title: "US Top Income Share vs Tax Rates (1913 ~ 2024) - Data"
author: "coop711"
date: "`r Sys.Date()`"
...
준비한 자료는  [E. Saez 교수의 홈페이지](http://elsa.berkeley.edu/~saez/)에 있는 `TabFig2024.xlsx` 와 [Tax Foundation](http://taxfoundation.org/)에서 제공하는 자료를 손봐서 불러들인 것이다. 
...
```{r, save.image}
save.image(file = "US_top_income_shares_vs_tax_rates_2024.RData")
```
