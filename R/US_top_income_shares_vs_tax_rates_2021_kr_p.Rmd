---
title: "US Top Marginal Tax Rates vs Top Income Shares (1913 ~ 2021)"
author: "coop711"
date: "`r Sys.Date()`"
...
library(extrafont)
#> 데이터 불러 들이기
load("US_top_income_shares_vs_tax_rates_2021.RData")
```
...
```{r, save.image}
save.image(file = "US_top_income_shares_vs_tax_rates_2021_v2.RData")
```
-->
