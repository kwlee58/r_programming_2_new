---
title: "Marginal Tax Rates vs US Income (1913 ~ 2024) : ggplot"
author: "coop711"
date: "`r Sys.Date()`"
...
준비한 자료는  [E. Saez 교수의 홈페이지](http://elsa.berkeley.edu/~saez/)에 있는 `TabFig2024prel.xls` 와 [Tax Foundation](http://taxfoundation.org/)에서 제공하는 자료를 손봐서 불러들인 것이다. 
...
#> 데이터 불러 들이기
load("US_top_income_shares_vs_tax_rates_2024_v2.RData")
```
