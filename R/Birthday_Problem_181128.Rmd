...
quiz0523 <- "../data/quiz181128v2.xlsx" %>% 
  read.xlsx(sheetIndex = 1, 
            startRow = 2, endRow = 43, 
            colIndex = 1:5, colClasses = rep("character", 5),
            encoding = "UTF-8",
            stringsAsFactors = FALSE)
quiz0523 %>% str
quiz0523$id <- 1:nrow(quiz0523)
quiz0523 <- quiz0523[, c(6, 1:5)]
...
#> Q3
quiz0523$Q3 %<>% factor(levels = c("가", "나"), 
                        labels = c("연비 10 => 12", "연비 30 => 40"))
#> Q4
quiz0523$Q4 %<>% factor(levels = c("가", "나"),
                        labels = c("수용가능", "불공정"))
# str(quiz0523)
pander(quiz0523[c("Q3", "Q4", "group")])
```
