---
title: "Marginal Tax Rates vs US Income (1913 ~ 2022) : ggplot"
author: "coop711"
date: "`r Sys.Date()`"
...
showtext_auto()
#> 데이터 불러 들이기
load("US_top_income_shares_vs_tax_rates_2022_v2.RData")
```
...
M1 <- 
  ggplot(data = M_tbl, 
         mapping = aes(x = Year, 
                       ...
                       colour = Variables, 
                       linetype = Variables,
                       linewidth = ifelse(Variables == "P99_100_z", 1.2, 2.5))) +
...
R1 <- ggplot(data = Rates_tbl, 
             mapping = aes(x = Year, 
                           ...
                           colour = Variables, 
                           linetype = Variables,
                           linewidth = ifelse(Variables == "Marginal_z", 2.5, 1))) +
  geom_line(show.legend = FALSE) +
