---
title: "Quiz 241104 (Birthday Problem, Matching Problem, Monty Hall Show)"
author: "coop711"
date: "2024-11-04"
...
quiz <- "../data/birthday_problem_ar_2402.xlsx" %>% 
  read_excel(range = "B2:K185",
             col_names = FALSE,
             col_types = "text")
quiz %>% 
  str
...
quiz[paste("Q2", 1:4, sep = "_")] %<>% sapply(FUN = . %>% {substr(., 1, 1)})
