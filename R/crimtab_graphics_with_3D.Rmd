...
# On headless servers you may need rgl::rgl.useNULL(TRUE)
library(rgl)
...
# persp3d expects x, y as vectors and z as a matrix
open3d()
persp3d(x = x_vals, y = y_vals, z = z,
        xlab = "Finger length (cols)",
        ylab = "Height (rows)",
        zlab = "Count",
        col = "lightgray")
rglwidget()
