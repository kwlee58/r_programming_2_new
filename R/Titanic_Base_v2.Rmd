...
library(ggplot2)
# library(extrafont)
## showtext 패키지 사용. 설치 먼저 하여야 함.
library(showtext)
## system에 받아 놓은 KoPubWorld Dotum 폰트 패밀리를 사용.
## family 에는 애칭으로 사용할 편한 이름을 적고, regular font 와 bold font의 파일명을 적어 줌. 
## 파일명에 따라 font_add 가 파일을 찾아내고, regular 를 부르려면 
## font = 1 (default 라 명시하지 않아도 됨), bold 를 부르려면 font = 2 를 명시하여 줌.
font_add(family = "KWD", 
         regular = "KoPubWorld Dotum Medium.ttf", 
         bold = "KoPubWorld Dotum Bold.ttf")
## 이후 자동으로 선택한 폰트를 보여줌.
showtext_auto()
data(Titanic)
Titanic %>% str
